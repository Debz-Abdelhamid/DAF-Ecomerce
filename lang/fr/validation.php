...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné a été vu dans une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    | en utilisant la convention "attribut.règle" pour nommer les lignes. Cela permet de
    | spécifier rapidement un message de langue personnalisé pour une règle d'attribut donnée.
    |
    */
    ...
    | d’attribut par quelque chose de plus convivial, comme "Adresse e-mail" au lieu
    | de "email". Cela nous aide à rendre notre message plus expressif.
    |
    */
