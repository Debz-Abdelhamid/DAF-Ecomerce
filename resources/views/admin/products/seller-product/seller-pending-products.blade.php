                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Sellers Pending Products</h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="13" class="text-center">No Pending products available.</td>
                                        </tr>
                                    @endforelse
                                </table>
                                {{ $products->links() }}
        ...
        $(document).ready(function(){
            ...
            $('body').on('change', '.is_approve',function(){
                ...
                $.ajax({
                    ...
                    {
                        notyf.success(data.message);
                        window.location.href = "{{ route('admin.seller-pending-products.index') }}";                               
