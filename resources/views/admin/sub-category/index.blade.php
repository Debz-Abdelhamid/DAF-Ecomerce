                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>@lang('admin.AllSubCategories')</h4>
                            <div class="card-header-action">
                                <a href="{{ route('admin.sub-category.create') }}" class="btn btn-success"><i
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">@lang('admin.Nosubcategoriesavailable') <a
                                                    href="{{ route('admin.sub-category.create') }}"
                                                    class="btn btn-success ml-2">@lang('admin.CreateSubCategory')</a></td>
                                        </tr>
