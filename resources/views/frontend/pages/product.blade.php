                        ...
                        <div class="col-xl-12  d-md-block mt-md-4 mt-lg-0">
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills d-none d-md-flex" id="v-pills-tab" role="tablist"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="row">
                                    @forelse($products as $product)
                                        <div class="col-xl-4 col-sm-6 mb-4">
                                            <div  class="wsus__product_item d-block">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    @if(checkDiscount($product))
                                                        ...
                                                        <div class="d-flex justify-center items-center text-center">
                                                            <p class="wsus__price text-danger"> {{ $product->price_60 }} {{ $settings->currency_icon }} <span class="text-danger"><b>/Mois </b></span></p>
                                                        </div>
                                                    @else
                                    ...
                                    @empty
                                        <div class="text-center mt-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2>@lang('product.ProductNotFound')</h2>
                                                </div>
                                            </div>
                                        </div>
                                    @endforelse
                            ...
                            <div class="tab-pane fade {{ session()->has('product_list_style') && session()->get('product_list_style') == 'list' ? 'show active' : '' }}" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                <div class="row">
                                    @forelse($products as $product)
                                        <div class="col-xl-12">
                                            <div class="wsus__product_item wsus__list_view d-none d-md-block">
                                                <span class="wsus__new " style="background-color:red; font-size:18px;padding-bottom: 20px;">{{ productType($product->type) }}</span>
                                                @if(checkDiscount($product))
                                                    <span class="wsus__minus">{{ calculateDiscountPercent($product->price, $product->offer_price) }}</span>
                                                @endif
                                                <a class="wsus__pro_link" href="{{ route('product-detail', $product->slug) }}">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    @if(checkDiscount($product))
                                                        <p class="wsus__price">
                                                            <span><b>@lang('product.Prix_Total') :</b></span> &nbsp; {{ $product->offer_price }} {{ $settings->currency_icon }} <del>{{ $product->price }} {{ $settings->currency_icon }}</del>
                                                        </p>
                                                        <div class="d-flex justify-center items-center text-center">
                                                            <p class="wsus__price text-danger"><span><b>@lang('product.price60') :</b></span> &nbsp; {{ $product->price_60 }} {{ $settings->currency_icon }} <span class="text-danger"><b> / @lang('product.Mois') </b></span></p>
                                                        </div>
                                                    @else
                                                    
                                                    <p class="wsus__price" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
                                                        <span><b>@lang('product.Prix_Total') :</b></span> &nbsp; 
                                                        {{ $product->price }} {{ $settings->currency_icon }}
                                                    </p>

                                                      
                                                        <div class="d-flex justify-center items-center text-center pt-2" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
                                                            <p class="wsus__price text-danger">
                                                                <span><b>@lang('product.price60') :</b></span> &nbsp; 
                                                                {{ $product->price_60 }} {{ $settings->currency_icon }} 
                                                                <span class="text-danger"><b>/ @lang('product.Mois')</b></span>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            @endforeach
                                                            <input type="hidden" name="qty" min="1" max="100" value="1" />
                                                            <!--<button type="submit" class="add_cart" style="border: none; background-color: green; border-radius: 4px;">@lang('product.add_to_cart')</button>-->
                                                        </form>
                                                    </ul>
                                                </div>
                                            </div>
