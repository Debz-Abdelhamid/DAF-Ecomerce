            ...
            <div class="wsus__offer_details_area">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        @if(App::getLocale() == 'ar')
                            <div class="wsus__section_header rounded-0" dir='rtl'>
                            <h3>@lang('navbar.flash_sale') :</h3>
                                <div class="wsus__offer_countdown">
                                    <span class="end_text">@lang('navbar.ends_time') :</span>
                        ...
                        <div class="col-xl-3 col-sm-6 col-lg-4">
                            <div class="wsus__product_item">
                                ...
                                <div class="wsus__product_details">
                                    ...
                                    <button style="border: none; ;" type="submit" class="" href="#">
