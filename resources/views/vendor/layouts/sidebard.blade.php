<div class="dashboard_sidebar">
    ...
    <a href="{{ route('vendor.dashboard') }}" class="dash_logo"><img src="" alt="logo" class="img-fluid"></a>
    <ul class="dashboard_link">
      ...
      <li><a class="{{setActive(['vendor.product.*'])}}" href="{{ route('vendor.product.index') }}"><i class="far fa-cart-plus"></i>Products</a></li>
